...
# Import the existing public key (generated manually on your local machine)     
resource "aws_key_pair" "omega_key" {
  key_name   = "omega-key"
  public_key = file("~/.ssh/omega-key.pub")  # Path to your generated public key
}

# Create the EC2 instance with the uploaded public key
